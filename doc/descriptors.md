# Support for Output Descriptors in Pottercoin Core

Since Pottercoin Core v0.17, there is support for Output Descriptors. This is a
...
on Pottercoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Pottercoin Core wallets, a convenience function `combo` is
