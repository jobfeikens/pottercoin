...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 rons per kB (0.00001 POT). This is to prepare for dropping the minimum transaction fee to 0.1 rons per kB (0.0001 POT) in the next release.
