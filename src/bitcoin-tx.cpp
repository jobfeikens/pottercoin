...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pottercoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pottercoin-tx [options] <hex-tx> [commands]  Update hex-encoded pottercoin transaction\n" +
            "or:     pottercoin-tx [options] -create [commands]   Create hex-encoded pottercoin transaction\n" +
            "\n";
