    ...
    for (int i = 0; i < RUN_TESTS; i++)
    {
      ...
      // test randomness
      {
          ...
          for (int i = 0; i < RUN_TESTS; i++) {
            ...
            BOOST_CHECK(testWallet.SelectCoinsMinConf(10 * COIN, filter_standard, GroupCoins(vCoins), setCoinsRet , nValueRet, coin_selection_params, bnb_used));
            BOOST_CHECK(testWallet.SelectCoinsMinConf(10 * COIN, filter_standard, GroupCoins(vCoins), setCoinsRet2, nValueRet, coin_selection_params, bnb_used));
