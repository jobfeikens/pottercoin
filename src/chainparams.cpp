...
{
    const char* pszTimestamp = "5 May 2021 - Je bent een pikkie";
    const CScript genesisOutputScript = CScript() << ParseHex("0465f90af1f4bed5c28da4c5bbcd1b64d94d7be2b5f18223535e118e92a4427c9c56d792ee892670d9fd568c652523de166f8666ec590dddc8c29f53ab5c68ab3c") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621103859, 2084533160, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        //printf("%s\n", consensus.hashGenesisBlock.ToString().c_str());

        assert(consensus.hashGenesisBlock == uint256S("0x8d22b9995f2f07160e120e0aa11711a7668768619d7f5ce2c9adac1936bbffb8"));
        ...
        checkpointData = {
            {
                {  0, uint256S("0x8d22b9995f2f07160e120e0aa11711a7668768619d7f5ce2c9adac1936bbffb8")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1621103859, 2370536, 0x1e0ffff0, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0xceb8b43f6e575c6e187570c4308bd010b104cacd28b0da027518b06aa8d22c56"));
        assert(genesis.hashMerkleRoot == uint256S("0x2bc4193256c4e46c41013797c70ffc0772e32a7a722c073faf77d0991253c30a"));
        ...
        checkpointData = {
            {
                {0, uint256S("ceb8b43f6e575c6e187570c4308bd010b104cacd28b0da027518b06aa8d22c56")},
            }
        };
