...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.pottercoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.pottercointools.com");
        vSeeds.emplace_back("dnsseed.pottercoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.pottercointools.com");
        vSeeds.emplace_back("seed-b.pottercoin.loshan.co.uk");
