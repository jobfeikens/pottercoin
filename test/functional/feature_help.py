...
"""Verify that starting pottercoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pottercoin with -h for help text")
        ...
        self.log.info("Start pottercoin with -version for version information")
        ...
        self.log.info("Start pottercoind with -fakearg to make sure it does not start")
